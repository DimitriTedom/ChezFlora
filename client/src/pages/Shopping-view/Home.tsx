    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="w-full h-full flex flex-col gap-8 lg:flex-row lg:justify-between xl:justify-between mt-32">
        <div className="flex flex-col gap-6 lg:max-w-[45%]">
          ...
          <div>
            <img src="/flowerGen5.jpg" alt="heroImage" className="rounded-[2rem] lg:h-[80%] lg:w-[100%] xl:h-[70%]"/>
          </div>
      ...
      {/* Featured Products */}
      <section className="flex flex-col gap-8 mt-[4rem] bg-green-200 p-[3rem] rounded-3xl">
          <div>
           <FormTitle title='Featured Products' comment={`Whether you're offering an elegant bouquet, beautifying your home or celebrating a special occasion, our featured products are carefully chosen for their freshness.`}/>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          <ProductCard title="Lavender the flower of summer " price={10.99} units={10} image="/flowerGen4(Services).jpg" discount={20}/>
          <ProductCard title="Lavender" price={143.99} units={20} image="/flowerGen4(Services).jpg" discount={40}/>
          <ProductCard title="Lavender" price={10.99} units={10} image="/flowerGen4(Services).jpg"/>
          </div>
      </section>
    </div>
  )
